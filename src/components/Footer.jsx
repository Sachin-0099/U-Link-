...
const DubaiMap = () => {
  ...
  return (
      ...
      >
          <MapContainer center={[25.276987, 55.296249]} zoom={13} scrollWheelZoom={false} className="h-full w-full">
              <TileLayer
...
const NewsletterForm = () => {
  ...
  return (
      <div className="space-y-4">
              ...
              <div className="relative">
                  <motion.label
                      ...
                      className={`absolute left-4 transition-all duration-300 ${
                          message ? 'top-1 text-xs text-[#b73235] dark:text-red-400' : 'top-3 text-gray-500'
                      }`}
                      initial={false}
                      animate={{
                          y: message ? -10 : 0,
          ...
          >
              <p className="text-sm text-gray-500 dark:text-gray-400">Or connect with:</p>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        <h4 className="text-md font-medium text-gray-600 dark:text-gray-300">Where to find us</h4>
                        <DubaiMap />
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <div className="mt-6">
                            <h4 className="text-md font-medium text-[#b73235] dark:text-gray-300 mb-3">Follow Us</h4>
                            <div className="flex gap-3">
