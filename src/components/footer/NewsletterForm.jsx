         ...
         <div className="relative">
                  ...
                  <motion.input
                    ...
                    className={`w-full px-4 pt-5 pb-2 rounded border ${
                      shake ? "border-[#b73235]" : "border-gray-300 dark:border-gray-700"
                    } dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#b73235]`}
                    animate={{
                ...
                <div className="relative">
                  <motion.label
                    ...
                    className={`absolute left-4 transition-all duration-300 ${
                      message
                        ? "top-1 text-xs text-[#b73235] dark:text-[#b73235]"
                        : "top-3 text-gray-500"
                    }`}
                    initial={false}
                    animate={{
                ...
                <motion.button
                  ...
                  className={`w-full px-4 py-3 rounded-md text-white font-medium ${
                    isSubmitting
                      ...
                      : "bg-gradient-to-r from-[#b73236] to-[#b73235] hover:from-[#b73235] hover:to-[#b73235]]"
                ...
                <AnimatePresence>
                  {submitSuccess && (
                    <motion.div
                      ...
                      className="text-center p-3 rounded-lg bg-green-100 dark:bg-red-900 text-red-700 dark:text-red-200"
                    >
