...
const OfficeInfo = ({ title, address, phone, email, website }) => {
  ...
  return (
    ...
    >
      <h3 
        className="text-lg font-semibold text-[#b73235] dark:text-white flex items-center gap-2"
        itemProp="name"
      >
        <motion.div
      ...
      >
        ...
        <motion.a
          href={`tel:${phone}`}
          title={`Call ${phone}`}
          className="flex items-center gap-2 hover:text-[#b73235] transition-colors"
          whileHover={{ x: 5 }}
          itemProp="telephone"
