          ...
          >
            ...
            <div className="space-y-8 order-2 lg:order-1">
              ...
              <motion.div variants={fadeIn} className="flex space-x-4">
                ...
                <a href={portfolioData.dheeraj.social.github} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-gray-200 dark:bg-green-500 hover:bg-[#b73235] hover:text-white transition-colors duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
